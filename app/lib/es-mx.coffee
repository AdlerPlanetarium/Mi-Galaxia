module.exports =
  home:
    ...
    intro:
      """
      A lo largo y ancho de este sitio podrán encontrar información general de lo que pueden experimentar al visitar el Planetario Adler tal como conocer parte del universo, desde planetas extraños, a diferentes clases de estrellas, hasta lejanas galaxias, todo a través de películas, exposiciones e interesantes actividades distribuidas en los tres niveles del museo.
      """
  nav:
    home: "Casa"
    event: "Evento"
    ...
    adlerActivities:
      ...
      volunteer:
        ...
        content:
          ...
          """
      k12:
        title: "K-12 oportunidades (campamentos, excursiones, etc)"
        content:
          """
          Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
          """
